...
<body>
    <div class="container border border-dark border-2 rounded p-3 mt-4">
        ...
        <h2>Update</h2>
        <img class='img-thumbnail rounded-circle' src='picture/<?php echo $data['picture'] ?>'
            alt="<?php echo $f_name ?>">
        <form method="post" enctype="multipart/form-data">
            <table class="table">
                <tr>
                    <th>First Name</th>
                    <td><input class="form-control" type="text" name="first_name" placeholder="First Name"
                            value="<?php echo $first_name ?>" /></td>
                </tr>
                <tr>
                    <th>Last Name</th>
                    <td><input class="form-control" type="text" name="last_name" placeholder="Last Name"
                            value="<?php echo $last_name ?>" /></td>
                </tr>
                <tr>
                    <th>Email</th>
                    <td><input class="form-control" type="email" name="email" placeholder="Email"
                ...
                <tr>
                    <th>Address</th>
                    <td><input class="form-control" type="address" name="address" placeholder="address"
                            value="<?php echo $address ?>" /></td>
                </tr>
                <tr>
                    <th>Phone Number</th>
                    <td><input class="form-control" type="text" name="phone_number" placeholder="+43**"
